...
| nodeAgent.monitors | object | `{}` | Per-monitor configuration keyed by plugin name. Omit or leave empty to enable all monitors (default). Example: To disable the networking monitor:   monitors:     networking:       enabled: false |
