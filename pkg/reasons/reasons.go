...
var (
	...
	CoreDNSCorefileReloadFailed = ReasonMeta{
		template:        "CoreDNSCorefileReloadFailed",
		defaultSeverity: "Warning",
	}
	CoreDNSCorefileRevertedToBaseline = ReasonMeta{
		template:        "CoreDNSCorefileRevertedToBaseline",
		defaultSeverity: "Warning",
	}
	CoreDNSCorefileRevertedToLastApplied = ReasonMeta{
		template:        "CoreDNSCorefileRevertedToLastApplied",
		defaultSeverity: "Warning",
	}
	CoreDNSCorefileValidationFailed = ReasonMeta{
		template:        "CoreDNSCorefileValidationFailed",
		defaultSeverity: "Warning",
	}
...
var byName = map[string]ReasonMeta{
	...
	"CoreDNSCorefileReloadFailed":          CoreDNSCorefileReloadFailed,
	"CoreDNSCorefileRevertedToBaseline":    CoreDNSCorefileRevertedToBaseline,
	"CoreDNSCorefileRevertedToLastApplied": CoreDNSCorefileRevertedToLastApplied,
	"CoreDNSCorefileValidationFailed":      CoreDNSCorefileValidationFailed,
